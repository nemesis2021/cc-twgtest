...
import { BlogPostsSectionModel } from '../../utils/models/customPostTypes/BlogPostModel';
...
interface Props {
  data: BlogPostsSectionModel;
}

export default function BlogPostsSection(props: Props) {
  const { data } = props;
  const { heading, link, blogPosts } = data;
