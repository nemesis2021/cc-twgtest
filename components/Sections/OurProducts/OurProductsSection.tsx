...
import { OurProductsSectionModel } from '../../../utils/models/pages/OurProductsPageModel';
      ...
      <ContentContainer>
        {products.nodes.map((product, index) => (
          <ProductOverviewSection
            ...
            isLast={index === products.nodes.length - 1}
            nextProductSlug={products.nodes[index + 1]?.slug}
          />
        ))}
      </ContentContainer>
    </Box>
