...
import type { PrivacyPolicyPageModel } from '../utils/models/pages/PrivacyPolicyPageModel';
import getHead from '../utils/queries/rankmath/getHead';
import getPrivacyPolicyPage from '../utils/queries/pages/getPrivacyPolicyPage';
...
import { PRIVACY_POLICY_PAGE } from '../utils/routes';
...
export default function PrivacyPolicy(props: Props) {
  ...
  const { heading, contents } = page.privacyPolicyPage;
...
export const getStaticProps: GetStaticProps = async () => {
  const head = await getHead({ url: PRIVACY_POLICY_PAGE });
